      ...
      >
        ...
        <div className=" h-full flex flex-col justify-center items-center xl:items-start z-20 pt-12">
          ...
          >
            ...
            >
              <motion.div
                ...
                whileInView={"show"}
                viewport={{ once: false, amount: 0.3 }}
                className="w-[300px] h-[100px] xl:w-[625px] xl:h-[164.97px]"
              >
                <Image
                  src={"/assets/hero/Swift.svg"}
                  fill
                  alt=""
                  className="object-contain"
                />
          ...
          <motion.div
            ...
            className="min-h-[60px] flex items-center mb-6 text-[20px]"
          >
        ...
        <motion.div
          ...
          whileInView={"show"}
          viewport={{ once: false, amount: 0.7 }}
          className="hidden xl:flex absolute right-1 top-0 before:w-[784px] before:h-[893px]
             before:absolute before:right-0 before:top-0 before:bg-singerOverlay before:z-10"
        >
          <Image
            src={"/assets/hero/mmmm.png"}
            width={617}
            height={893}
            alt=""
            quality={100}
