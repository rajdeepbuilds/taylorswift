  ...
  return (
    <motion.div
      ...
      <div className="flex flex-col xl:flex-row justify-between h-[620px] xl:h-full gap-x-4">
        ...
        {/*Event list*/}
        <div
          className="flex-1 h-[500px] flex flex-col 
        ...
        >
          ...
          {events.map((event) => {
            return (
              <div
                key={event.id}
                className="flex flex-col xl:flex-row items-center justify-between gap-y-4
                     bg-pink-400/10 xl:gap-y-0 text-center xl:text-left my-4 xl:my-0 border-b
